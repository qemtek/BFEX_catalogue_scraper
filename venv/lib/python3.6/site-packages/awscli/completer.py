...
class Completer(object):
    def __init__(self, driver=None):
        ...
        self.main_options = self._get_documented_completions(self.main_help.arg_table)
    ...
    def _complete_command(self, command_name, command_help, current_arg, opts):
        if current_arg == command_name:
            if command_help:
                return self._get_documented_completions(command_help.command_table)
    ...
    def _complete_provider(self, current_arg, opts):
        if current_arg.startswith("-"):
            ...
            return self._get_documented_completions(self.main_help.command_table)
        else:
    ...
    def _find_possible_options(self, current_arg, opts, subcmd_help=None):
        ...
        if subcmd_help is not None:
            all_options += self._get_documented_completions(subcmd_help.arg_table)
