...
class GetTokenCommand(BasicCommand):
    ...
    def _run_main(self, parsed_args, parsed_globals, token_generator=None):
        ...
        token = token_generator.get_token(
            parsed_args.cluster_name, parsed_args.role_arn, parsed_globals.region
        )
        ...
        full_object = {
            ...
            "spec": {},
            "status": {"expirationTimestamp": token_expiration, "token": token},
        }
...
class TokenGenerator(object):
    ...
    def _get_presigned_url(self, cluster_name, role_arn, region_name=None):
        session = self._session_handler.get_session(region_name, role_arn)
        ...
        endpoint = endpoint_resolver.construct_endpoint(AUTH_SERVICE, region_name)
