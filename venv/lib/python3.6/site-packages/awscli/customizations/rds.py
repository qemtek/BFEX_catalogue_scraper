...
def register_rds_modify_split(cli):
    ...
    cli.register(
        "building-argument-table.rds.add-option-to-option-group", _rename_add_option
    )
    cli.register(
...
def _rename_add_option(argument_table, **kwargs):
    utils.rename_argument(argument_table, "options-to-include", new_name="options")
    del argument_table["options-to-remove"]


def _rename_remove_option(argument_table, **kwargs):
    utils.rename_argument(argument_table, "options-to-remove", new_name="options")
