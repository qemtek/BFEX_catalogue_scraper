...
def register_lambda_create_function(cli):
    ...
    cli.register(
        "building-argument-table.lambda.update-function-code", _modify_zipfile_docstring
    )
    cli.register("process-cli-arg.lambda.update-function-code", validate_is_zip_file)
