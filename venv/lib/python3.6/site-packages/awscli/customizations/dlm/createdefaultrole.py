...
from awscli.customizations.dlm.constants import LIFECYCLE_DEFAULT_MANAGED_POLICY_NAME
from awscli.customizations.dlm.constants import LIFECYCLE_DEFAULT_ROLE_ASSUME_POLICY
from awscli.customizations.dlm.constants import LIFECYCLE_DEFAULT_ROLE_NAME
from awscli.customizations.dlm.constants import POLICY_ARN_PATTERN
...
def display_response(session, operation_name, result, parsed_globals):
    if result is not None:
        ...
        cli_operation_caller._display_response(operation_name, result, parsed_globals)
...
class CreateDefaultRole(BasicCommand):
    ...
    def _create_default_role_if_not_exists(self, parsed_globals):
        ...
        LOG.debug(
            "Role %s does not exist. " "Creating default role for Lifecycle", role_name
        )
        ...
        managed_policy_arn = get_policy_arn(
            region, LIFECYCLE_DEFAULT_MANAGED_POLICY_NAME
        )
