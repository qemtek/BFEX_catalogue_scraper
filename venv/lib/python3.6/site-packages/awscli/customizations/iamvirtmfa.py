...
BOOTSTRAP_HELP = (
    "Method to use to seed the virtual MFA.  " "Valid values are: %s | %s" % CHOICES
)
...
class IAMVMFAWrapper(object):
    def __init__(self, event_handler):
        ...
        self._outfile = FileArgument("outfile", help_text=OUTPUT_HELP, required=True)
        self._method = StatefulArgument(
            "bootstrap-method", help_text=BOOTSTRAP_HELP, choices=CHOICES, required=True
        )
        self._event_handler.register(
            "building-argument-table.iam.create-virtual-mfa-device", self._add_options
        )
        self._event_handler.register(
