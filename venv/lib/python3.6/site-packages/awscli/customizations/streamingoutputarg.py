...
def add_streaming_output_arg(argument_table, operation_model, session, **kwargs):
...
class StreamingOutputArgument(BaseCLIArgument):
    ...
    def __init__(self, response_key, operation_model, name, session, buffer_size=None):
        self._name = name
        self.argument_model = Shape("StreamingOutputArgument", {"type": "string"})
