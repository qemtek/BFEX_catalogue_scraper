...
class Deregister(BasicCommand):
    ...
    def _get_instance_info(self, params):
        ...
        if params.tags:
            ...
            for tag in params.tags:
                sys.stdout.write(" Key={0},Value={1}".format(tag["Key"], tag["Value"]))
            sys.stdout.write("\n")
    ...
    def _delete_user_policy(self, params):
        ...
        try:
            for response in list_user_policies.paginate(UserName=params.user_name):
    ...
    def _delete_iam_user(self, params):
        sys.stdout.write("Deleting the IAM user ({0})... ".format(params.user_name))
        try:
