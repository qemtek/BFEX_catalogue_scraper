...
class Install(BasicCommand):
    ...
    ARG_TABLE = [
        ...
        },
        {
            ...
            "required": False,
            "help_text": ("Optional. The AWS CodeDeploy Agent installer file."),
        },
    ]
    ...
    def _validate_override_config(self, params):
        if os.path.isfile(params.system.CONFIG_PATH) and not params.override_config:
            raise RuntimeError(
    ...
    def _create_config(self, params):
        sys.stdout.write("Creating the on-premises instance configuration file... ")
        try:
