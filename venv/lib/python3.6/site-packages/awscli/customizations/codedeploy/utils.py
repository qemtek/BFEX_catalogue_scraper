...
from awscli.compat import URLError
from awscli.compat import urlopen
from awscli.customizations.codedeploy.systems import RHEL
from awscli.customizations.codedeploy.systems import System
from awscli.customizations.codedeploy.systems import Ubuntu
from awscli.customizations.codedeploy.systems import Windows
...
IAM_USER_ARN_ARG = {
    ...
    "required": False,
    "help_text": ("Optional. The IAM user associated with the on-premises instance."),
}
