...
from awscli.customizations.codedeploy.locationargs import modify_revision_arguments
...
def initialize(cli):
    ...
    cli.register(
        "building-argument-table.deploy.create-deployment", modify_revision_arguments
    )
