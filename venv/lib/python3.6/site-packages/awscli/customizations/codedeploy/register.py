...
from awscli.customizations.codedeploy.utils import IAM_USER_ARN_ARG
from awscli.customizations.codedeploy.utils import INSTANCE_NAME_ARG
from awscli.customizations.codedeploy.utils import validate_iam_user_arn
from awscli.customizations.codedeploy.utils import validate_instance_name
from awscli.customizations.codedeploy.utils import validate_region
from awscli.customizations.codedeploy.utils import validate_tags
...
class Register(BasicCommand):
    ...
    def _run_main(self, parsed_args, parsed_globals):
        ...
        self.iam = self._session.create_client("iam", region_name=params.region)
    ...
    def _create_user_policy(self, params):
        ...
        sys.stdout.write(
            "DONE\n"
            "PolicyName: {0}\n"
            "PolicyDocument: {1}\n".format(params.policy_name, params.policy_document)
        )
