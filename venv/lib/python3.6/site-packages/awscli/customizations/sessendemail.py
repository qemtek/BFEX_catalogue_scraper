...
def register_ses_send_email(event_handler):
    event_handler.register("building-argument-table.ses.send-email", _promote_args)
    event_handler.register(
        "operation-args-parsed.ses.send-email",
        validate_mutually_exclusive_handler(["destination"], ["to", "cc", "bcc"]),
    )
    event_handler.register(
        "operation-args-parsed.ses.send-email",
...
def _promote_args(argument_table, **kwargs):
    ...
    argument_table["to"] = AddressesArgument("to", "ToAddresses", help_text=TO_HELP)
    argument_table["cc"] = AddressesArgument("cc", "CcAddresses", help_text=CC_HELP)
    argument_table["bcc"] = AddressesArgument("bcc", "BccAddresses", help_text=BCC_HELP)
