...
from awscli.customizations.servicecatalog.generatebase import GenerateBaseCommand
...
class GenerateProductCommand(GenerateBaseCommand):
    ...
    ARG_TABLE = [
        {"name": "product-name", "required": True, "help_text": helptext.PRODUCT_NAME},
        {"name": "product-owner", "required": True, "help_text": helptext.OWNER},
        {
            "name": "product-type",
            "required": True,
        ...
        {"name": "file-path", "required": True, "help_text": helptext.FILE_PATH},
        {"name": "bucket-name", "required": True, "help_text": helptext.BUCKET_NAME},
        {
    ...
    def _run_main(self, parsed_args, parsed_globals):
        ...
        self.s3_url = self.create_s3_url(parsed_args.bucket_name, parsed_args.file_path)
