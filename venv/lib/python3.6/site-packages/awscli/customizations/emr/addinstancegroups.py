...
class AddInstanceGroups(Command):
    ...
    def _run_main_command(self, parsed_args, parsed_globals):
        ...
        parameters["InstanceGroups"] = instancegroupsutils.build_instance_groups(
        ...
        constructed_result = self._construct_result(add_instance_groups_response)

        emrutils.display_response(
            self._session, "add_instance_groups", constructed_result, parsed_globals
        )
        return 0
    ...
    def _construct_result(self, add_instance_groups_result):
        ...
        if add_instance_groups_result is not None:
            ...
            instanceGroupIds = add_instance_groups_result.get("InstanceGroupIds")

        if jobFlowId is not None and instanceGroupIds is not None:
            return {"ClusterId": jobFlowId, "InstanceGroupIds": instanceGroupIds}
        else:
            return {}
