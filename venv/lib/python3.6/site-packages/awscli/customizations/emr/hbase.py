...
class RestoreFromHBaseBackup(Command):
    ...
    DESCRIPTION = "Restores HBase from S3. " + helptext.AVAILABLE_ONLY_FOR_AMI_VERSIONS
    ARG_TABLE = [
        {"name": "cluster-id", "required": True, "help_text": helptext.CLUSTER_ID},
        {"name": "dir", "required": True, "help_text": helptext.HBASE_BACKUP_DIR},
...
class CreateHBaseBackup(Command):
    ...
    DESCRIPTION = (
        "Creates a HBase backup in S3. " + helptext.AVAILABLE_ONLY_FOR_AMI_VERSIONS
    )
    ARG_TABLE = [
        {"name": "cluster-id", "required": True, "help_text": helptext.CLUSTER_ID},
        {"name": "dir", "required": True, "help_text": helptext.HBASE_BACKUP_DIR},
...
class DisableHBaseBackups(Command):
    ...
    ARG_TABLE = [
        {"name": "cluster-id", "required": True, "help_text": helptext.CLUSTER_ID},
        {"name": "full", "action": "store_true", "help_text": "Disables full backup."},
        {
            "name": "incremental",
            "action": "store_true",
    ...
    def _build_hbase_disable_backups_args(self, parsed_args):
        args = [constants.HBASE_MAIN, constants.HBASE_SCHEDULED_BACKUP, constants.FALSE]
