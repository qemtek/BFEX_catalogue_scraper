...
SUPPORTED_CONFIG_LIST = [
    ...
    {"name": "key_name", "arg_name": "ec2_attributes", "arg_value_key": "KeyName"},
...
def _create_supported_configuration(config):
    ...
    if config_type == "string":
        config_arg_name = config["arg_name"] if "arg_name" in config else config["name"]
...
def _create_supported_configurations():
    return [_create_supported_configuration(config) for config in SUPPORTED_CONFIG_LIST]
