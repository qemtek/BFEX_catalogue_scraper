...
ADDITIONAL_INFO = "<p>Specifies additional information during cluster creation.</p>"
...
AVAILABLE_ONLY_FOR_AMI_VERSIONS = (
    "This command is only available when using Amazon EMR versions" "earlier than 4.0."
)
