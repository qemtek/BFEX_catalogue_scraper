...
class Command(BasicCommand):
    ...
    def _run_main(self, parsed_args, parsed_globals):
        ...
        self._apply_configs(parsed_args, configutils.get_configs(self._session))
    ...
    def _apply_configs(self, parsed_args, parsed_configs):
        ...
        for configuration in applicable_configurations:
            configuration.add(self, parsed_args, parsed_configs[configuration.name])
            configs_added[configuration.name] = parsed_configs[configuration.name]
    ...
    def _validate_unsupported_commands_for_release_based_clusters(
        ...
        if command in self.UNSUPPORTED_COMMANDS_FOR_RELEASE_BASED_CLUSTERS and hasattr(
