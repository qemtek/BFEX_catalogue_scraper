...
class SubscribeCommand(BasicCommand):
    NAME = "subscribe"
    DESCRIPTION = (
        "Subcribes user to AWS Config by creating an AWS Config "
    ...
    def _run_main(self, parsed_args, parsed_globals):
        ...
        self._config_client.put_configuration_recorder(
            ConfigurationRecorder={"name": name, "roleARN": parsed_args.iam_role}
        )
        ...
        self._config_client.put_delivery_channel(DeliveryChannel=delivery_channel)

        # Start the configuration recorder.
        self._config_client.start_configuration_recorder(ConfigurationRecorderName=name)
        ...
        sys.stdout.write(json.dumps(response["ConfigurationRecorders"], indent=4))
        sys.stdout.write("\n\n")
    ...
    def _setup_clients(self, parsed_globals):
        ...
        self._config_client = self._session.create_client("config", **client_args)
