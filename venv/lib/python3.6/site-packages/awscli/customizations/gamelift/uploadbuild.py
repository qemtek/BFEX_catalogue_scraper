...
class UploadBuildCommand(BasicCommand):
    ...
    ARG_TABLE = [
        {"name": "name", "required": True, "help_text": "The name of the build"},
        {
            "name": "build-version",
            "required": True,
    ...
    def _run_main(self, args, parsed_globals):
        ...
        create_build_kwargs = {"Name": args.name, "Version": args.build_version}
        ...
        try:
            ...
            s3_transfer_mgr.upload_file(
                ...
                callback=ProgressPercentage(
                    temporary_zipfile, label="Uploading " + args.build_root + ":"
                ),
            )
        finally:
            os.close(fd)
