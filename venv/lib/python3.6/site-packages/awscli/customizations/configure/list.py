...
class ConfigureListCommand(BasicCommand):
    ...
    def _run_main(self, args, parsed_globals):
        self._display_config_value(ConfigValue("Value", "Type", "Location"), "Name")
    ...
    def _lookup_credentials(self):
        ...
        if access_key.value is not NOT_SET:
            ...
            if credentials is None:
                ...
                access_key = ConfigValue(credentials.access_key, credentials.method, "")
                secret_key = ConfigValue(credentials.secret_key, credentials.method, "")
                access_key.mask_value()
                secret_key.mask_value()
                return access_key, secret_key
    ...
    def _lookup_config(self, name):
        ...
        if value is not None:
            return ConfigValue(
                value, "config-file", self._session.get_config_variable("config_file")
            )
        else:
