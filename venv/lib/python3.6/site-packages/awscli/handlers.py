...
from awscli.customizations.codedeploy.codedeploy import initialize as codedeploy_init
...
from awscli.customizations.configservice.rename_cmd import register_rename_config
...
from awscli.customizations.generatecliskeleton import register_generate_cli_skeleton
...
def awscli_initialize(event_handlers):
    ...
    event_handlers.register(
        "building-argument-table.ec2.get-password-data", ec2_add_priv_launch_key
    )
