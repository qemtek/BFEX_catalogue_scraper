...
class TestFFT1D(object):
    def test_fft(self):
        ...
        assert_array_almost_equal(fft1(x) / np.sqrt(30), np.fft.fft(x, norm="ortho"))
    ...
    def test_fft2(self):
        ...
        assert_array_almost_equal(
            np.fft.fft(np.fft.fft(x, axis=1), axis=0), np.fft.fft2(x)
        )
        assert_array_almost_equal(
            np.fft.fft2(x) / np.sqrt(30 * 20), np.fft.fft2(x, norm="ortho")
        )

    def test_ifft2(self):
        x = random((30, 20)) + 1j * random((30, 20))
        assert_array_almost_equal(
            np.fft.ifft(np.fft.ifft(x, axis=1), axis=0), np.fft.ifft2(x)
        )
        assert_array_almost_equal(
            np.fft.ifft2(x) * np.sqrt(30 * 20), np.fft.ifft2(x, norm="ortho")
        )
    ...
    def test_fftn(self):
        ...
        assert_array_almost_equal(
            np.fft.fftn(x) / np.sqrt(30 * 20 * 10), np.fft.fftn(x, norm="ortho")
        )
    ...
    def test_ifftn(self):
        ...
        assert_array_almost_equal(
            np.fft.ifftn(x) * np.sqrt(30 * 20 * 10), np.fft.ifftn(x, norm="ortho")
        )
    ...
    def test_rfft(self):
        ...
        for n in [x.size, 2 * x.size]:
            ...
            assert_array_almost_equal(
                np.fft.rfft(x, n=n) / np.sqrt(n), np.fft.rfft(x, n=n, norm="ortho")
            )
    ...
    def test_rfft2(self):
        ...
        assert_array_almost_equal(
            np.fft.rfft2(x) / np.sqrt(30 * 20), np.fft.rfft2(x, norm="ortho")
        )
    ...
    def test_rfftn(self):
        ...
        assert_array_almost_equal(
            np.fft.rfftn(x) / np.sqrt(30 * 20 * 10), np.fft.rfftn(x, norm="ortho")
        )
    ...
    def test_hfft(self):
        ...
        assert_array_almost_equal(
            np.fft.hfft(x_herm) / np.sqrt(30), np.fft.hfft(x_herm, norm="ortho")
        )
    ...
    def test_ihttf(self):
        ...
        assert_array_almost_equal(
            x_herm, np.fft.ihfft(np.fft.hfft(x_herm, norm="ortho"), norm="ortho")
        )
