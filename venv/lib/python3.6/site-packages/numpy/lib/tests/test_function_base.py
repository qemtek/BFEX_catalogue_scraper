...
from numpy.lib import digitize
from numpy.lib import extract
from numpy.lib import flipud
...
from numpy.lib import msort
from numpy.lib import piecewise
from numpy.lib import place
from numpy.lib import rot90
from numpy.lib import select
from numpy.lib import setxor1d
from numpy.lib import sinc
from numpy.lib import trapz
from numpy.lib import trim_zeros
...
class Test_I0(object):
    def test_simple(self):
        ...
        assert_almost_equal(
            i0(A), np.array([1.06307822, 1.12518299, 1.01214991, 1.00006049])
        )
...
class TestPercentile(object):
    ...
    def test_nan_behavior(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            warnings.filterwarnings("always", "", RuntimeWarning)
            assert_equal(
                np.percentile(a, [0.3, 0.6], (0, 2), interpolation="nearest"), b
            )
