...
class ClientArgsCreator(object):
    ...
    def get_client_args(
        ...
        if signing_region is None and endpoint_region_name is None:
            signing_region, endpoint_region_name = self._get_default_s3_region(
                service_name, endpoint_bridge
            )
    ...
    def compute_client_args(
        ...
        s3_config = self.compute_s3_config(scoped_config, client_config)
        return {
    ...
    def compute_s3_config(self, scoped_config, client_config):
        ...
        if scoped_config is not None:
            ...
            if not isinstance(s3_configuration, dict):
                logger.debug(
                    "The s3 config key is not a dictionary type, "
