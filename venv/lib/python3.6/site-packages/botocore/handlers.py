...
def register_retries_for_service(service_data, session, service_name, **kwargs):
    ...
    if endpoint_prefix is None:
        logger.debug(
            ...
            "prefix from model for service %s",
            service_name,
        )
        return
    ...
    session.register("needs-retry.%s" % endpoint_prefix, handler, unique_id=unique_id)
