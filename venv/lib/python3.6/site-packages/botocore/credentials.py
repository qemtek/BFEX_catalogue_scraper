...
def create_credential_resolver(session, cache=None):
    ...
    providers = [
        ...
        SharedCredentialProvider(
            creds_filename=credential_file, profile_name=profile_name
        ),
        ProcessProvider(
            profile_name=profile_name, load_config=lambda: session.full_config
        ),
...
class AssumeRoleCredentialFetcher(CachedCredentialFetcher):
    def __init__(
        ...
        super(AssumeRoleCredentialFetcher, self).__init__(cache, expiry_window_seconds)
