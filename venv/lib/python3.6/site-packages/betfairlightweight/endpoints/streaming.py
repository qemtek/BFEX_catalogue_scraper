from ..streaming import BaseListener
from ..streaming import BetfairStream
from ..streaming import HistoricalStream
...
class Streaming(object):
    ...
    def create_historical_stream(
        directory, listener=None, operation="marketSubscription"
    ):
        """
