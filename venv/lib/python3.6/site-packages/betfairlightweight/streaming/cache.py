...
from ..enums import StreamingOrderType
from ..enums import StreamingPersistenceType
from ..enums import StreamingSide
from ..enums import StreamingStatus
from ..exceptions import CacheError
from ..resources import BaseResource
from ..resources import CurrentOrders
from ..resources import MarketBook
from ..resources import MarketDefinition
from ..resources import Race
...
class OrderBookRunner(object):
    ...
    def serialise_orders(self, market_id):
        return [
            ...
            for order in self.unmatched_orders
        ]
