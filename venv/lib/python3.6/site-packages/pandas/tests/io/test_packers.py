...
from pandas.io.packers import read_msgpack
from pandas.io.packers import to_msgpack
...
class TestAPI(TestPackers):
    ...
    def test_invalid_arg(self):
        ...
        msg = r"Invalid file path or buffer object type: <(class|type)" r" '{}'>"
