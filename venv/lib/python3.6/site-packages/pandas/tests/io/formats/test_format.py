...
from pandas.core.config import reset_option
...
class TestDataFrameFormatting(object):
    ...
    def test_repr_truncates_terminal_size(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "pandas.io.formats.console.get_terminal_size", lambda: terminal_size
        )
        monkeypatch.setattr(
    ...
    def test_to_string_with_formatters_unicode(self):
        ...
        result = df.to_string(formatters={u("c/\u03c3"): lambda x: "{x}".format(x=x)})
        assert result == u("  c/\u03c3\n") + "0   1\n1   2\n2   3"
    ...
    def test_east_asian_unicode_false(self):
        ...
        # mid col
        df = DataFrame(
            {"a": [u"あ", u"いいい", u"う", u"ええええええ"], "b": [1, 222, 33333, 4]},
            index=["a", "bb", "c", "ddd"],
        )
        expected = (
            u"          a      b\na         あ      1\n"
        ...
        # last col
        df = DataFrame(
            {"a": [1, 222, 33333, 4], "b": [u"あ", u"いいい", u"う", u"ええええええ"]},
            index=["a", "bb", "c", "ddd"],
        )
        expected = (
            u"         a       b\na        1       あ\n"
        ...
        # all col
        df = DataFrame(
            {"a": [u"あああああ", u"い", u"う", u"えええ"], "b": [u"あ", u"いいい", u"う", u"ええええええ"]},
            index=["a", "bb", "c", "ddd"],
        )
        expected = (
            u"         a       b\na    あああああ       あ\n"
        ...
        # column name
        df = DataFrame(
            {"b": [u"あ", u"いいい", u"う", u"ええええええ"], u"あああああ": [1, 222, 33333, 4]},
            index=["a", "bb", "c", "ddd"],
        )
        expected = (
            u"          b  あああああ\na         あ      1\n"
        ...
        idx = pd.MultiIndex.from_tuples(
            [(u"あ", u"いい"), (u"う", u"え"), (u"おおお", u"かかかか"), (u"き", u"くく")]
        )
        df = DataFrame(
            {"a": [u"あああああ", u"い", u"う", u"えええ"], "b": [u"あ", u"いいい", u"う", u"ええええええ"]},
            index=idx,
    ...
    def test_east_asian_unicode_true(self):
        ...
        with option_context("display.unicode.east_asian_width", True):
            ...
            # ambiguous unicode
            df = DataFrame(
                {"b": [u"あ", u"いいい", u"¡¡", u"ええええええ"], u"あああああ": [1, 222, 33333, 4]},
                index=["a", "bb", "c", "¡¡¡"],
            )
            expected = (
                u"                b  あああああ\n"
    ...
    def test_pprint_thing(self):
        ...
        assert pp_t((u("\u05d0"), u("\u05d1")), quote_strings=True) == u(
            "(u'\u05d0', u'\u05d1')"
        )
        assert pp_t((u("\u05d0"), (u("\u05d1"), u("\u05d2"))), quote_strings=True) == u(
            "(u'\u05d0', " "(u'\u05d1', u'\u05d2'))"
        )
        assert pp_t(
            ("foo", u("\u05d0"), (u("\u05d0"), u("\u05d0"))), quote_strings=True
        ) == u("(u'foo', u'\u05d0', " "(u'\u05d0', u'\u05d0'))")
    ...
    def test_to_string(self):
        ...
        # big mixed
        biggie = DataFrame(
            {"A": np.random.randn(200), "B": tm.makeStringIndex(200)}, index=lrange(200)
        )
...
class TestSeriesFormatting(object):
    ...
    def test_east_asian_unicode_series(self):
        ...
        # unicode index
        s = Series(["a", "bb", "CCC", "D"], index=[u"あ", u"いい", u"ううう", u"ええええ"])
        expected = (
            u"あ         a\nいい       bb\nううう     CCC\n" u"ええええ      D\ndtype: object"
        )
        ...
        # both
        s = Series([u"あ", u"いい", u"ううう", u"ええええ"], index=[u"ああ", u"いいいい", u"う", u"えええ"])
        expected = (
            u"ああ         あ\nいいいい      いい\nう        ううう\n" u"えええ     ええええ\ndtype: object"
        )
        assert _rep(s) == expected
        ...
        s = Series(
            [1, 22, 3333, 44444], index=[1, "AB", pd.Timestamp("2011-01-01"), u"あああ"]
        )
        expected = (
            u"1                          1\n"
            u"AB                        22\n"
        ...
        with option_context("display.unicode.east_asian_width", True):
            ...
            # both
            s = Series(
                [u"あ", u"いい", u"ううう", u"ええええ"], index=[u"ああ", u"いいいい", u"う", u"えええ"]
            )
            expected = (
                u"ああ              あ\n"
                u"いいいい        いい\n"
