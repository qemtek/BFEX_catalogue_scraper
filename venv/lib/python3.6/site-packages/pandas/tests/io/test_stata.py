...
class TestStata(object):
    ...
    def test_write_variable_label_errors(self):
        ...
        values = [u"\u03A1", u"\u0391", u"\u039D", u"\u0394", u"\u0391", u"\u03A3"]
    ...
    def test_repeated_column_labels(self):
        # GH 13923
        msg = (
            r"Value labels for column ethnicsn are not unique\. The"
    ...
    def test_unicode_dta_118(self):
        ...
        values = [
            [u"ραηδας", u"PÄNDÄS", "p", u"ραηδας", "p"],
    ...
    def test_invalid_file_not_written(self, version):
        ...
        with tm.ensure_clean() as path:
            ...
            with pytest.raises(expected_exc, match=r"{}|{}".format(msg1, msg2)):
    ...
    def test_strl_latin1(self):
        ...
        output = DataFrame(
            [[u"pandas"] * 2, [u"þâÑÐÅ§"] * 2], columns=["var_str", "var_strl"]
        )
