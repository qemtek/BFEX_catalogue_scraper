...
from pandas.io.json.table_schema import as_json_table_type
from pandas.io.json.table_schema import build_table_schema
from pandas.io.json.table_schema import convert_json_field_to_pandas_type
from pandas.io.json.table_schema import convert_pandas_type_to_json_field
from pandas.io.json.table_schema import set_default_names
...
class TestTableOrientReader(object):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param({"floats": [1.0, 2.0, 3.0, 4.0]}, marks=pytest.mark.xfail),
    ...
    @pytest.mark.parametrize(
        "strict_check", [pytest.param(True, marks=pytest.mark.xfail), False]
    )
    def test_empty_frame_roundtrip(self, strict_check):
        ...
        tm.assert_frame_equal(
            expected, result, check_dtype=strict_check, check_index_type=strict_check
        )
