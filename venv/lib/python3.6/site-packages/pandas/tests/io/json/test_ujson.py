...
json_unicode = json.dumps if compat.PY3 else partial(json.dumps, encoding="utf-8")
...
class TestUltraJSONTests(object):
    ...
    @pytest.mark.skipif(
        compat.is_platform_windows() and not compat.PY3,
    ...
    def test_load_file(self):
        ...
        f = StringIO(data)
        tm.assert_numpy_array_equal(np.array(exp_data), ujson.load(f, numpy=True))
