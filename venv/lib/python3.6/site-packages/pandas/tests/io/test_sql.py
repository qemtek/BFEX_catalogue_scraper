...
class _TestSQLApi(PandasSQLTest):
    ...
    def test_to_sql_panel(self):
        panel = tm.makePanel()
        pytest.raises(NotImplementedError, sql.to_sql, panel, "test_panel", self.conn)
...
class TestSQLiteFallbackApi(SQLiteMixIn, _TestSQLApi):
    ...
    def test_con_string_import_error(self):
        if not SQLALCHEMY_INSTALLED:
            ...
            pytest.raises(ImportError, sql.read_sql, "SELECT * FROM iris", conn)
        else:
...
class _TestSQLAlchemy(SQLAlchemyMixIn, PandasSQLTest):
    ...
    def test_dtype(self):
        ...
        pytest.raises(ValueError, df.to_sql, "error", self.conn, dtype={"B": str})
...
class TestSQLiteFallback(SQLiteMixIn, PandasSQLTest):
    ...
    def test_dtype(self):
        ...
        pytest.raises(ValueError, df.to_sql, "error", self.conn, dtype={"B": bool})
