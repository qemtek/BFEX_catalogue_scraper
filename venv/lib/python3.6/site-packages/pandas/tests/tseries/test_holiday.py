...
class TestCalendar(object):
    ...
    def test_calendar(self):
        ...
        holidays_2 = calendar.holidays(
            Timestamp(self.start_date), Timestamp(self.end_date)
        )
    ...
    def test_calendar_observance_dates(self):
        ...
        holidays0 = USFedCal.holidays(
            datetime(2015, 7, 3), datetime(2015, 7, 3)
        )  # <-- same start and end dates
        holidays1 = USFedCal.holidays(
            datetime(2015, 7, 3), datetime(2015, 7, 6)
        )  # <-- different start and end dates
        holidays2 = USFedCal.holidays(
            datetime(2015, 7, 3), datetime(2015, 7, 3)
        )  # <-- same start and end dates
...
class TestHoliday(object):
    ...
    def test_holidays_within_dates(self):
        ...
        holidays = {
            ...
            EasterMonday: [("2015-04-06", "2015-04-06"), ("2015-04-05", [])],
            new_years: [
                ("2015-01-01", "2015-01-01"),
                ("2011-01-01", []),
                ("2010-12-31", "2010-12-31"),
            ],
            july_4th: [("2015-07-03", "2015-07-03"), ("2015-07-04", [])],
            veterans_day: [("2012-11-11", []), ("2012-11-12", "2012-11-12")],
            christmas: [("2011-12-25", []), ("2011-12-26", "2011-12-26")],
        }
    ...
    def test_factory(self):
        ...
        class_2 = HolidayCalendarFactory(
            "Thansksgiving", AbstractHolidayCalendar, USThanksgivingDay
        )
...
class TestFederalHolidayCalendar(object):
    def test_no_mlk_before_1986(self):
        ...
        holidays = (
            MLKCalendar().holidays(start="1984", end="1988").to_pydatetime().tolist()
        )
    ...
    def test_memorial_day(self):
        ...
        holidays = (
            MemorialDay().holidays(start="1971", end="1980").to_pydatetime().tolist()
        )
