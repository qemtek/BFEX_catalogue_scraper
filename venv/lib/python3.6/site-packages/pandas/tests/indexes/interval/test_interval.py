...
class TestIntervalIndex(Base):
    ...
    def test_set_operation_errors(self, closed, op_name, sort):
        ...
        # non-IntervalIndex
        msg = (
            "the other index needs to be an IntervalIndex too, but "
            "was type Int64Index"
        )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            lzip(
                date_range("20170101", periods=10), date_range("20170101", periods=10)
            ),
            lzip(
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            lzip(date_range("20170101", periods=10), date_range("20170101", periods=10))
            + [np.nan],
            lzip(
                timedelta_range("0 days", periods=10),
                timedelta_range("1 day", periods=10),
