...
class TestDatetimeIndex(object):
    ...
    def test_constructor_coverage(self):
        ...
        pytest.raises(ValueError, date_range, start="2011-01-01", freq="b")
        pytest.raises(ValueError, date_range, end="2011-01-01", freq="B")
    ...
    def test_constructor_dtype(self):
        ...
        pytest.raises(ValueError, lambda: DatetimeIndex(idx, dtype="datetime64[ns]"))

        # this is effectively trying to convert tz's
        pytest.raises(
            TypeError, lambda: DatetimeIndex(idx, dtype="datetime64[ns, CET]")
        )
        pytest.raises(
            ValueError,
            lambda: DatetimeIndex(idx, tz="CET", dtype="datetime64[ns, US/Eastern]"),
        )
