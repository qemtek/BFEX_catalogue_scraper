...
class TestPeriodIndex(object):
    ...
    def test_constructor_field_arrays(self):
        ...
        months = [1, 2]
        pytest.raises(ValueError, PeriodIndex, year=years, month=months, freq="M")
        pytest.raises(ValueError, PeriodIndex, year=years, month=months, freq="2M")
        pytest.raises(
            ValueError,
            PeriodIndex,
            year=years,
    ...
    def test_constructor_U(self):
        ...
        pytest.raises(ValueError, period_range, "2007-1-1", periods=500, freq="X")
    ...
    def test_constructor_fromarraylike(self):
        ...
        pytest.raises(TypeError, PeriodIndex, data=Period("2007", freq="A"))
    ...
    def test_constructor_nat(self):
        pytest.raises(ValueError, period_range, start="NaT", end="2011-01-01", freq="M")
        pytest.raises(ValueError, period_range, start="2011-01-01", end="NaT", freq="M")
