...
class TestCategoricalIndex(Base):
    ...
    def test_method_delegation(self):
        ...
        # invalid
        pytest.raises(ValueError, lambda: ci.set_categories(list("cab"), inplace=True))
    ...
    def test_append(self):
        ...
        pytest.raises(
            TypeError, lambda: ci.append(ci.values.set_categories(list("abcd")))
        )
        pytest.raises(
            TypeError, lambda: ci.append(ci.values.reorder_categories(list("abc")))
        )
    ...
    def test_get_indexer(self):
        ...
        pytest.raises(NotImplementedError, lambda: idx2.get_indexer(idx1, method="pad"))
        pytest.raises(
            NotImplementedError, lambda: idx2.get_indexer(idx1, method="backfill")
        )
        pytest.raises(
            NotImplementedError, lambda: idx2.get_indexer(idx1, method="nearest")
        )
    ...
    def test_equals_categorical(self):
        ...
        pytest.raises(TypeError, lambda: ci1 == Categorical(ci1.values, ordered=False))
        pytest.raises(
            TypeError, lambda: ci1 == Categorical(ci1.values, categories=list("abc"))
        )
