...
class TestCategoricalDtype(Base):
    ...
    def test_construction_from_string(self):
        ...
        pytest.raises(TypeError, lambda: CategoricalDtype.construct_from_string("foo"))
...
class TestDatetimeTZDtype(Base):
    ...
    def test_construction(self):
        pytest.raises(ValueError, lambda: DatetimeTZDtype("ms", "US/Eastern"))
    ...
    def test_construction_from_string(self):
        ...
        assert is_dtype_equal(self.dtype, result)
        pytest.raises(TypeError, lambda: DatetimeTZDtype.construct_from_string("foo"))
