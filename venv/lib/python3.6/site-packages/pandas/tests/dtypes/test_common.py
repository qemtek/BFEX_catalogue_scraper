...
from pandas.conftest import ALL_INT_DTYPES
from pandas.conftest import SIGNED_EA_INT_DTYPES
from pandas.conftest import SIGNED_INT_DTYPES
from pandas.conftest import UNSIGNED_EA_INT_DTYPES
from pandas.conftest import UNSIGNED_INT_DTYPES
...
@pytest.mark.parametrize(
    "input_param", [None, 1, 1.2, "random string", pd.DataFrame([1, 2])]
)
