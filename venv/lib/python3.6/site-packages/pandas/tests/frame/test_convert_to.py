...
class TestDataFrameConvertTo(TestData):
    ...
    def test_to_records_with_unicode_index(self):
        ...
        result = DataFrame([{u"a": u"x", u"b": "y"}]).set_index(u"a").to_records()
    ...
    def test_to_records_with_unicode_column_names(self):
        ...
        expected = np.rec.array(
            [(0, 1.0)],
            dtype={"names": ["index", u"accented_name_é"], "formats": ["=i8", "=f8"]},
        )
        tm.assert_almost_equal(result, expected)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                np.rec.array(
                    [(0.0, u"1", 2, 3.0), (1.0, u"4", 5, 6.0), (2.0, u"7", 8, 9.0)],
                    dtype=[
                        ("index", "<f4"),
                        ("('a', 'd')", "<U1"),
                        ("('b', 'e')", "<i8"),
    ...
    @pytest.mark.parametrize("mapping", [list, collections.defaultdict, []])
