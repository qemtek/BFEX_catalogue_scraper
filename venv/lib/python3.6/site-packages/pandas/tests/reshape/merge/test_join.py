...
from pandas.tests.reshape.merge.test_merge import get_test_data
from pandas.tests.reshape.merge.test_merge import N
from pandas.tests.reshape.merge.test_merge import NGROUPS
...
class TestJoin(object):
    ...
    def test_panel_join_many(self):
        with catch_warnings(record=True):
            ...
            panels = [panel.iloc[:2, :-5], panel.iloc[2:6, 2:], panel.iloc[6:, 5:-7]]
            ...
            with pytest.raises(ValueError, match=msg):
                panels[0].join(panels[1:], how="outer", lsuffix="foo", rsuffix="bar")
