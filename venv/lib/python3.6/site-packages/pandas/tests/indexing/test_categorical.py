...
class TestCategoricalIndex(object):
    ...
    def test_reindexing(self):
        ...
        pytest.raises(
            NotImplementedError, lambda: self.df2.reindex(["a"], method="ffill")
        )
        pytest.raises(NotImplementedError, lambda: self.df2.reindex(["a"], level=1))
        pytest.raises(NotImplementedError, lambda: self.df2.reindex(["a"], limit=2))
