...
class Base(object):
    ...
    def setup_method(self, method):
        ...
        self.frame_ints = DataFrame(
            np.random.randn(4, 4), index=lrange(0, 8, 2), columns=lrange(0, 12, 3)
        )
        ...
        self.series_uints = Series(
            np.random.rand(4), index=UInt64Index(lrange(0, 8, 2))
        )
        ...
        self.panel_ts_rev = Panel(np.random.randn(4, 4, 4), items=dates_rev)
