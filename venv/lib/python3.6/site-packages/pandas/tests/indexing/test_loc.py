...
class TestLoc(Base):
    ...
    def test_loc_getitem_int(self):
        ...
        self.check_result(
            "int label", "loc", 4, "ix", 4, typs=["ints", "uints"], axes=2
        )
        self.check_result(
    ...
    @pytest.mark.skipif(
        PY2, reason=("Catching warnings unreliable with " "Python 2 (GH #20770)")
    )
    ...
    def test_loc_to_fail(self):
        ...
        # raise a KeyError?
        pytest.raises(KeyError, df.loc.__getitem__, tuple([[1, 2], [1, 2]]))
...
Region_1,Site_2,3977723089,A,5/20/2015 8:33,5/20/2015 9:09,Yes,No"""
    ...
    def test_loc_non_unique(self):
        ...
        pytest.raises(KeyError, df.loc.__getitem__, tuple([slice(1, None)]))
        pytest.raises(KeyError, df.loc.__getitem__, tuple([slice(0, None)]))
