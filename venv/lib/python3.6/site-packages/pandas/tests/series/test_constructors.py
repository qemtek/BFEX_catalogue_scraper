...
class TestSeriesConstructors:
    ...
    def test_constructor_dtype_datetime64(self):
        ...
        pytest.raises(
            TypeError,
            lambda x: Series(Series(dates).astype("int") / 1000000, dtype="M8[ms]"),
        )

        msg = (
            r"The 'datetime64' dtype has no unit\. Please pass in"
    ...
    def test_constructor_name_hashable(self):
        for n in [777, 777.0, "name", datetime(2001, 11, 11), (1,), u"\u05D0"]:
