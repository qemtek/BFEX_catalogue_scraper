...
class TestSeriesAnalytics(object):
    ...
    def test_argsort_stable(self):
        ...
        msg = (
            r"ndarray Expected type <(class|type) 'numpy\.ndarray'>,"
    ...
    def test_built_in_round(self):
        ...
        result = round(s)
        expected_rounded0 = Series([1.0, 2.0, 3.0], index=lrange(3))
    ...
    def test_prod_numpy16_bug(self):
        s = Series([1.0, 1.0, 1.0], index=lrange(3))
        result = s.prod()
    ...
    def test_corr_rank(self):
        ...
        if LooseVersion(scipy.__version__) < LooseVersion("0.9"):
            pytest.skip(
                "skipping corr rank because of scipy version "
...
class TestCategoricalSeriesAnalytics(object):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "unicode_",
            "timedelta64[h]",
            pytest.param("datetime64[D]", marks=pytest.mark.xfail(reason="GH#7996")),
        ],
    )
    ...
    def test_drop_duplicates_categorical_non_bool(self, dtype, is_ordered):
        ...
        tc1 = Series(Categorical(input1, categories=cat_array, ordered=is_ordered))
        ...
        tc2 = Series(Categorical(input2, categories=cat_array, ordered=is_ordered))
    ...
    def test_drop_duplicates_categorical_bool(self, is_ordered):
        tc = Series(
            Categorical(
                [True, False, True, False], categories=[True, False], ordered=is_ordered
            )
        )
