...
def test_is_level_reference_panel_error(panel):
    msg = "_is_level_reference is not implemented for {type}".format(type=type(panel))
...
def test_is_label_reference_panel_error(panel):
    msg = "_is_label_reference is not implemented for {type}".format(type=type(panel))
...
def test_is_label_or_level_reference_panel_error(panel):
    msg = "_is_label_or_level_reference is not implemented for {type}".format(
        type=type(panel)
    )
...
def test_check_label_or_level_ambiguity_panel_error(panel):
    msg = "_check_label_or_level_ambiguity is not implemented for {type}".format(
        type=type(panel)
    )
...
def test_get_label_or_level_values_panel_error(panel):
    msg = "_get_label_or_level_values is not implemented for {type}".format(
        type=type(panel)
    )
...
def test_drop_labels_or_levels_panel_error(panel):
    msg = "_drop_labels_or_levels is not implemented for {type}".format(
        type=type(panel)
    )
