...
class TestConfig(object):
    ...
    def test_register_option(self):
        ...
        # can't register an already registered option
        pytest.raises(KeyError, self.cf.register_option, "a.b.c.d1", 1, "doc")
        pytest.raises(KeyError, self.cf.register_option, "a.b.c.d2", 1, "doc")
        ...
        pytest.raises(ValueError, self.cf.register_option, "Oh my Goddess!", 0)
    ...
    def test_validation(self):
        ...
        pytest.raises(
            ...
            "NO",
            "doc",
            validator=self.cf.is_int,
        )

        self.cf.set_option("a", 2)  # int is_int
        self.cf.set_option("b.c", "wurld")  # str is_str

        pytest.raises(ValueError, self.cf.set_option, "a", None)  # None not is_int
    ...
    def test_deprecate_option(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            pytest.raises(KeyError, self.cf.deprecate_option, "a")  # can't depr. twice
