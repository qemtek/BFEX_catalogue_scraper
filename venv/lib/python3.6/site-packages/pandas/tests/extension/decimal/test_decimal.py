...
from .array import DecimalArray
from .array import DecimalDtype
from .array import make_data
from .array import to_decimal
...
class TestInterface(BaseDecimal, base.BaseInterfaceTests):
    ...
    pytestmark = pytest.mark.skipif(compat.PY2, reason="Unhashble dtype in Py2.")
...
class TestArithmeticOps(BaseDecimal, base.BaseArithmeticOpsTests):
    def check_opname(self, s, op_name, other, exc=None):
        super(TestArithmeticOps, self).check_opname(s, op_name, other, exc=None)
    ...
    def _check_divmod_op(self, s, op, other, exc=NotImplementedError):
        # We implement divmod
        super(TestArithmeticOps, self)._check_divmod_op(s, op, other, exc=None)
...
def test_formatting_values_deprecated():
    ...
    with tm.assert_produces_warning(
        DeprecationWarning, check_stacklevel=check_stacklevel
    ):
        repr(ser)
