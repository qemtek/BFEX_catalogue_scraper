...
from pandas.core.generic import _shared_doc_kwargs
...
from pandas.plotting._tools import _get_all_lines
from pandas.plotting._tools import _get_xlim
from pandas.plotting._tools import _handle_shared_axes
from pandas.plotting._tools import _set_ticks_props
from pandas.plotting._tools import _subplots
from pandas.plotting._tools import format_date_labels
...
class LinePlot(MPLPlot):
    ...
    def _ts_plot(cls, ax, x, data, style=None, **kwds):
        from pandas.plotting._timeseries import (
            _maybe_resample,
            _decorate_axes,
            format_dateaxis,
        )
        ...
        **kwds
        ...
        if LooseVersion(spv) >= "0.11.0":
            ...
            if bw_method is not None:
                msg = (
                    "bw_method was added in Scipy 0.11.0."
