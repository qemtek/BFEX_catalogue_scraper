...
from pandas._libs.tslibs.offsets import _get_calendar
from pandas._libs.tslibs.offsets import _is_normalized
from pandas._libs.tslibs.offsets import _to_dt64
from pandas._libs.tslibs.offsets import apply_index_wraps
from pandas._libs.tslibs.offsets import ApplyTypeError
from pandas._libs.tslibs.offsets import as_datetime
from pandas._libs.tslibs.offsets import BaseOffset
from pandas._libs.tslibs.offsets import roll_yearday
from pandas._libs.tslibs.offsets import shift_month
...
class BusinessHourMixin(BusinessMixin):
    ...
    def apply(self, other):
        ...
        if isinstance(other, datetime):
            ...
            if (
                (daytime and (result.time() < self.start or self.end < result.time()))
                or not daytime
                and (self.end < result.time() < self.start)
            ):
                if n >= 0:
