...
from pandas.core.internals import _block2d_to_blocknd
from pandas.core.internals import _block_shape
from pandas.core.internals import _factor_indexer
...
# axes map
_AXES_MAP = {DataFrame: [0], Panel: [1, 2]}
...
class HDFStore(StringMixin):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                'HDFStore requires PyTables, "{ex!s}" problem '
...
class LegacyTable(Table):
    ...
    def read(self, where=None, columns=None, **kwargs):
        ...
        if len(unique(key)) == len(key):
            ...
            sorter, _ = algos.groupsort_indexer(ensure_int64(key), np.prod(N))
