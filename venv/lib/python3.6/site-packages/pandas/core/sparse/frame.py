...
from pandas._libs.sparse import get_blocks
...
from pandas.core.internals.construction import extract_index
...
class SparseDataFrame(DataFrame):
    ...
    def _apply_columns(self, func):
        ...
        new_data = {col: func(series) for col, series in compat.iteritems(self)}
    ...
    def density(self):
        ...
        """
        tot_nonsparse = sum(ser.sp_index.npoints for _, ser in compat.iteritems(self))
    ...
    def fillna(
        ...
        new_self = super(SparseDataFrame, self).fillna(
            value=value,
            method=method,
            axis=axis,
            inplace=inplace,
