...
def _interpolate_scipy_wrapper(
    ...
    try:
        ...
        raise ImportError("{method} interpolation requires SciPy".format(method=method))
    ...
    if method == "pchip":
        ...
        try:
            ...
            raise ImportError(
                "Your version of Scipy does not support " "Akima interpolation."
            )
...
def _from_derivatives(xi, yi, x, order=None, der=0, extrapolate=False):
    ...
    if LooseVersion(scipy.__version__) < LooseVersion("0.18.0"):
        try:
            ...
            return method(xi, yi.reshape(-1, 1), x, orders=order, der=der)
        except AttributeError:
            pass
