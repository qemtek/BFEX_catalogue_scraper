...
from pandas.core.computation.ops import _cmp_ops_syms
from pandas.core.computation.ops import _LOCAL_TAG
from pandas.core.computation.ops import _mathops
from pandas.core.computation.ops import _reductions
from pandas.core.computation.ops import _unary_ops_syms
...
def _preparse(source, f=_compose(_replace_locals, _replace_booleans, _rewrite_assign)):
        ...
        if isinstance(res, FuncNode):
            ...
            for key in node.keywords:
                ...
                if key.arg:
                    # TODO: bug?
                    kwargs.append(
                        ast.keyword(keyword.arg, self.visit(keyword.value))
                    )  # noqa
...
class PandasExprVisitor(BaseExprVisitor):
    def __init__(
        ...
        engine,
        parser,
        preparser=partial(_preparse, f=_compose(_replace_locals, _replace_booleans)),
    ):
