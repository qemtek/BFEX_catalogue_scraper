...
from pandas.core.dtypes.missing import _isna_compat
...
class Block(PandasObject):
    ...
    def _astype(self, dtype, copy=False, errors="raise", values=None, **kwargs):
        ...
        try:
            ...
            newb = make_block(
                values, placement=self.mgr_locs, klass=klass, ndim=self.ndim
            )
...
class ComplexBlock(FloatOrComplexBlock):
    ...
    def _can_hold_element(self, element):
        ...
        return isinstance(
            element, (float, int, complex, np.float_, np.int_, compat.long)
...
class DatetimeBlock(DatetimeLikeBlockMixin, Block):
    ...
    def __init__(self, values, placement, ndim=None):
        values = self._maybe_coerce_values(values)
        super(DatetimeBlock, self).__init__(values, placement=placement, ndim=ndim)
...
class DatetimeTZBlock(ExtensionBlock, DatetimeBlock):
    ...
    def concat_same_type(self, to_concat, placement=None):
        ...
        return super(DatetimeTZBlock, self).concat_same_type(to_concat, placement)

    def fillna(self, value, limit=None, inplace=False, downcast=None):
        # We support filling a DatetimeTZ with a `value` whose timezone
        # is different by coercing to object.
        try:
            return super(DatetimeTZBlock, self).fillna(value, limit, inplace, downcast)
...
class TimeDeltaBlock(DatetimeLikeBlockMixin, IntBlock):
    ...
    def __init__(self, values, placement, ndim=None):
        ...
        if isinstance(values, TimedeltaArray):
            values = values._data
        assert isinstance(values, np.ndarray), type(values)
        super(TimeDeltaBlock, self).__init__(values, placement=placement, ndim=ndim)
...
class BoolBlock(NumericBlock):
    ...
    def replace(
        ...
        if not np.can_cast(to_replace_values, bool):
            return self
        return super(BoolBlock, self).replace(
            to_replace,
            value,
            inplace=inplace,
            filter=filter,
...
class ObjectBlock(Block):
    ...
    def __init__(self, values, placement=None, ndim=2):
        ...
        super(ObjectBlock, self).__init__(values, ndim=ndim, placement=placement)
    ...
    def replace(
        ...
        if not either_list and is_re(to_replace):
            ...
            return super(ObjectBlock, self).replace(
                to_replace,
                value,
                inplace=inplace,
                filter=filter,
