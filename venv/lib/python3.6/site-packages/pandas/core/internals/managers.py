...
from .blocks import _extend_blocks
from .blocks import _merge_blocks
from .blocks import _safe_reshape
from .blocks import Block
from .blocks import CategoricalBlock
from .blocks import DatetimeTZBlock
from .blocks import ExtensionBlock
from .blocks import get_block_type
from .blocks import make_block
from .blocks import ObjectValuesExtensionBlock
from .concat import combine_concat_plans
from .concat import concatenate_join_units
from .concat import get_mgr_concatenation_plan
from .concat import is_uniform_join_units
...
class BlockManager(PandasObject):
    ...
    def apply(
        ...
        **kwargs
        ...
        aligned_args = {
            ...
            and not isinstance(kwargs[k], ABCExtensionArray)
        }
    ...
    def xs(self, key, axis=1, copy=True, takeable=False):
        ...
        if len(self.blocks) > 1:
            ...
            if copy:
                vals = vals.copy()
            new_blocks = [
                make_block(values=vals, placement=block.mgr_locs, klass=block.__class__)
            ]
    ...
    def merge(self, other, lsuffix="", rsuffix=""):
        ...
        l, r = items_overlap_with_suffix(
            left=self.items, lsuffix=lsuffix, right=other.items, rsuffix=rsuffix
        )
