...
from pandas.core.config import is_bool
...
from pandas.core.config import is_one_of_factory
from pandas.core.config import is_text
...
with cf.config_prefix("display"):
    ...
    cf.register_option(
        "date_yearfirst", False, pc_date_yearfirst_doc, validator=is_bool
    )
    ...
    cf.register_option(
        "encoding", detect_console_encoding(), pc_encoding_doc, validator=is_text
    )
...
cf.deprecate_option(
    "html.border", msg=pc_html_border_deprecation_warning, rkey="display.html.border"
)
