...
_op_descriptions = {
    ...
    "add": {"op": "+", "desc": "Addition", "reverse": "radd"},
    "sub": {"op": "-", "desc": "Subtraction", "reverse": "rsub"},
    "mul": {
        "op": "*",
        "desc": "Multiplication",
        "reverse": "rmul",
    ...
    "mod": {"op": "%", "desc": "Modulo", "reverse": "rmod"},
    "pow": {
        "op": "**",
    ...
    "eq": {"op": "==", "desc": "Equal to", "reverse": None},
    "ne": {"op": "!=", "desc": "Not equal to", "reverse": None},
    "lt": {"op": "<", "desc": "Less than", "reverse": None},
    "le": {"op": "<=", "desc": "Less than or equal to", "reverse": None},
    "gt": {"op": ">", "desc": "Greater than", "reverse": None},
    "ge": {"op": ">=", "desc": "Greater than or equal to", "reverse": None},
}
...
def _arith_method_PANEL(cls, op, special):
    ...
    def f(self, other):
        if not is_scalar(other):
            raise ValueError(
                "Simple arithmetic with {name} can only be "
                "done with scalar values".format(name=self._constructor.__name__)
            )
...
def _comp_method_PANEL(cls, op, special):
    ...
    def f(self, other, axis=None):
        ...
        elif isinstance(other, (self._constructor_sliced, ABCDataFrame, ABCSeries)):
            raise Exception(
                "input needs alignment for this object [{object}]".format(
    ...
    def na_op(x, y):
        ...
        try:
            result = expressions.evaluate(
                op, str_rep, x, y, errors="raise", **eval_kwargs
            )
        except TypeError:
            result = op(x, y)
