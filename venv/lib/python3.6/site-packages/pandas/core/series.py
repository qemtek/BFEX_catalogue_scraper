...
from pandas.core.dtypes.common import _is_unorderable_exception
...
class Series(base.IndexOpsMixin, generic.NDFrame):
    ...
    def searchsorted(self, value, side="left", sorter=None):
        ...
        result = self._values.searchsorted(
            Series(value)._values, side=side, sorter=sorter
        )
    ...
    def replace(
        ...
        return super(Series, self).replace(
    ...
    def shift(self, periods=1, freq=None, axis=0, fill_value=None):
        return super(Series, self).shift(
