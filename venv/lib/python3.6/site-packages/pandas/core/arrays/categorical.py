...
from .base import _extension_array_shared_docs
...
class Categorical(ExtensionArray, PandasObject):
    ...
    def _reverse_indexer(self):
        ...
        *This is an internal function*
        ...
        result = [
            r[counts[indexer] : counts[indexer + 1]]
    ...
    def _from_factorized(cls, uniques, original):
        return original._constructor(
            original.categories.take(uniques),
...
def _factorize_from_iterable(values):
    ...
    *This is an internal function*
    ...
    if is_categorical(values):
        ...
        categories = CategoricalIndex(
            values.categories, categories=values.categories, ordered=values.ordered
        )
        codes = values.codes
    else:
