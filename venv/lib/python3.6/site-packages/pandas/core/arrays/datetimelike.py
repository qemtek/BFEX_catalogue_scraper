...
from pandas._libs.tslibs.timestamps import round_nsint64
...
from pandas.core.dtypes.common import is_offsetlike
...
class DatetimeLikeArrayMixin(ExtensionOpsMixin, AttributesMixin, ExtensionArray):
    ...
    def __setitem__(
        ...
        if is_list_like(value):
            ...
            if not is_slice and len(key) != len(value) and not com.is_bool_indexer(key):
                msg = (
                    "shape mismatch: value array of length '{}' does not "
    ...
    def _reduce(self, name, axis=0, skipna=True, **kwargs):
        ...
        if op:
            ...
            return super(DatetimeLikeArrayMixin, self)._reduce(name, skipna, **kwargs)
