...
from pandas._libs.tslibs.timedeltas import precision_from_unit
...
def _is_convertible_to_td(key):
    return isinstance(key, (Tick, timedelta, np.timedelta64, compat.string_types))
...
class TimedeltaArray(dtl.DatetimeLikeArrayMixin, dtl.TimelikeOps):
    ...
    def _addsub_offset_array(self, other, op):
        ...
        try:
            ...
            return super(TimedeltaArray, self)._addsub_offset_array(other, op)
