        ...
        if isinstance(window, (list, tuple, np.ndarray)):
            ...
            def _validate_win_type(win_type, kwargs):
                ...
                if win_type in arg_map:
                    return tuple(
                        [win_type] + _pop_args(win_type, arg_map[win_type], kwargs)
                    )
                return win_type
...
class Rolling(_Rolling_and_Expanding):
    ...
    def validate(self):
        ...
        if (self.obj.empty or self.is_datetimelike) and isinstance(
            self.window, (compat.string_types, ABCDateOffset, timedelta)
        ):
    ...
    def apply(self, func, raw=None, args=(), kwargs={}):
        return super(Rolling, self).apply(func, raw=raw, args=args, kwargs=kwargs)
    ...
    def quantile(self, quantile, interpolation="linear", **kwargs):
        return super(Rolling, self).quantile(
...
class Expanding(_Rolling_and_Expanding):
    ...
    @Appender(_shared_docs["apply"])
    def apply(self, func, raw=None, args=(), kwargs={}):
        return super(Expanding, self).apply(func, raw=raw, args=args, kwargs=kwargs)
    ...
    @Appender(_shared_docs["quantile"])
    def quantile(self, quantile, interpolation="linear", **kwargs):
        return super(Expanding, self).quantile(
            quantile=quantile, interpolation=interpolation, **kwargs
        )
    ...
    @Appender(_shared_docs["cov"])
    def cov(self, other=None, pairwise=None, ddof=1, **kwargs):
        return super(Expanding, self).cov(
            other=other, pairwise=pairwise, ddof=ddof, **kwargs
        )
