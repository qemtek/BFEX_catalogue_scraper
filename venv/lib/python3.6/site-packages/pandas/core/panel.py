...
from pandas.core.dtypes.cast import maybe_cast_item
...
class Panel(NDFrame):
    ...
    def _init_dict(self, data, axes, dtype=None):
        ...
        if haxis is not None:
            ...
            data = OrderedDict((k, v) for k, v in compat.iteritems(data) if k in haxis)
        else:
    ...
    def rename(self, items=None, major_axis=None, minor_axis=None, **kwargs):
        ...
        return super(Panel, self).rename(
    ...
    def reindex_axis(
        ...
        return super(Panel, self).reindex_axis(
            labels=labels,
            axis=axis,
            method=method,
            level=level,
    ...
    def fillna(
        ...
        **kwargs
        ...
        return super(Panel, self).fillna(
            value=value,
            method=method,
            axis=axis,
            inplace=inplace,
