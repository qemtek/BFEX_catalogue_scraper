...
from pandas.core.dtypes.cast import coerce_to_dtypes
...
from pandas.core.internals.construction import masked_rec_array_to_mgr
...
class DataFrame(NDFrame):
    ...
    def __init__(self, data=None, index=None, columns=None, dtype=None, copy=False):
        ...
        elif isinstance(data, compat.Iterable) and not isinstance(
            data, string_and_binary_types
        ):
    ...
    def to_dict(self, orient="dict", into=dict):
        ...
        if orient.lower().startswith("d"):
            ...
            return into_c(
                (k, com.maybe_box_datetimelike(v)) for k, v in compat.iteritems(self)
            )
            ...
            return [
                into_c(
                    (k, com.maybe_box_datetimelike(v)) for k, v in compat.iteritems(row)
                )
                for row in rows
            ]
    ...
    def from_records(
        ...
        if index is not None:
            if isinstance(index, compat.string_types) or not hasattr(index, "__iter__"):
    ...
    def to_panel(self):
        ...
        if (
            ...
            or len(self.index.levels) != 2  # pragma: no cover
        ):
            raise NotImplementedError("Only 2-level MultiIndex are supported.")

        if not self.index.is_unique:
            raise ValueError("Can't convert non-uniquely indexed " "DataFrame to Panel")
        ...
        # create new manager
        new_mgr = selfsorted._data.reshape_nd(
            axes=new_axes,
    ...
    def align(
        ...
        return super(DataFrame, self).align(
            other,
            join=join,
            axis=axis,
            level=level,
    ...
    def reindex_axis(
        ...
        return super(DataFrame, self).reindex_axis(
            labels=labels,
            axis=axis,
            method=method,
            level=level,
    ...
    def drop(
        ...
        falcon  speed   320.0   250.0
                weight  1.0     0.8
        """
        return super(DataFrame, self).drop(
            labels=labels,
            axis=axis,
            index=index,
            columns=columns,
    ...
    @rewrite_axis_style_signature(
        "mapper", [("copy", True), ("inplace", False), ("level", None)]
    )
    ...
    def replace(
        ...
        return super(DataFrame, self).replace(
    ...
    def shift(self, periods=1, freq=None, axis=0, fill_value=None):
        return super(DataFrame, self).shift(
    ...
    def _aggregate(self, arg, axis=0, *args, **kwargs):
        if axis == 1:
            ...
            # only result
            result, how = super(DataFrame, self.T)._aggregate(arg, *args, **kwargs)
