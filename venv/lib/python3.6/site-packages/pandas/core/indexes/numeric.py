...
class NumericIndex(Index):
    ...
    def _shallow_copy(self, values=None, **kwargs):
        ...
        return super(NumericIndex, self)._shallow_copy(values=values, **kwargs)
...
class Int64Index(IntegerIndex):
    ...
    def _convert_scalar_indexer(self, key, kind=None):
        ...
        return super(Int64Index, self)._convert_scalar_indexer(key, kind=kind)
...
class UInt64Index(IntegerIndex):
    ...
    def _convert_scalar_indexer(self, key, kind=None):
        ...
        if kind != "iloc":
            key = self._maybe_cast_indexer(key)
        return super(UInt64Index, self)._convert_scalar_indexer(key, kind=kind)
...
class Float64Index(NumericIndex):
    ...
    def _convert_slice_indexer(self, key, kind=None):
        ...
        if kind == "iloc":
            return super(Float64Index, self)._convert_slice_indexer(key, kind=kind)
    ...
    def get_loc(self, key, method=None, tolerance=None):
        try:
            ...
            pass
        return super(Float64Index, self).get_loc(
