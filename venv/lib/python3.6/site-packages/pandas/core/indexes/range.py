...
class RangeIndex(Int64Index):
    ...
    def __new__(
        ...
        if isinstance(start, RangeIndex):
            if name is None:
                name = start.name
            return cls._simple_new(name=name, **dict(start._get_data_as_items()))
        ...
        def ensure_int(value, field):
            ...
            if not is_scalar(value):
                raise TypeError(msg.format(value=type(value).__name__, field=field))
            try:
                new_value = int(value)
    ...
    def nbytes(self):
        ...
        """
        return sum(
            getsizeof(getattr(self, v), 24) for v in ["_start", "_stop", "_step"]
        )
    ...
    def _shallow_copy(self, values=None, **kwargs):
        if values is None:
            ...
            return RangeIndex._simple_new(name=name, **dict(self._get_data_as_items()))
        else:
    ...
    def _minmax(self, meth):
        ...
        if no_steps == -1:
            return np.nan
        elif (meth == "min" and self._step > 0) or (meth == "max" and self._step < 0):
            return self._start
    ...
    def intersection(self, other, sort=False):
        ...
        tmp_start = (
            first._start + (second._start - first._start) * first._step // gcd * s
        )
    ...
    def join(self, other, how="left", level=None, return_indexers=False, sort=False):
        ...
        return super(RangeIndex, self).join(other, how, level, return_indexers, sort)
    ...
    def __floordiv__(self, other):
        ...
        if is_integer(other) and other != 0:
            if len(self) == 0 or self._start % other == 0 and self._step % other == 0:
            ...
            if len(self) == 1:
                start = self._start // other
                return RangeIndex._simple_new(start, start + 1, 1, name=self.name)
