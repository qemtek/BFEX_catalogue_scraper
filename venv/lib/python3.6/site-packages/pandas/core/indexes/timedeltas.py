...
from pandas.core.arrays.timedeltas import _is_convertible_to_td
...
from pandas.core.indexes.datetimelike import maybe_unwrap_index
from pandas.core.indexes.datetimelike import wrap_arithmetic_op
    ...
    def _maybe_cast_slice_bound(self, label, side, kind):
        ...
        if isinstance(label, compat.string_types):
            ...
            if side == "left":
                ...
                return lbound + to_offset(parsed.resolution) - Timedelta(1, "ns")
