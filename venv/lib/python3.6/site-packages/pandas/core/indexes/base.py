...
from pandas.core.dtypes.common import ensure_categorical
...
from pandas.core.dtypes.common import is_dtype_union_equal
...
class Index(IndexOpsMixin, PandasObject):
    ...
    def __new__(
        ...
        **kwargs
        ...
        if isinstance(data, RangeIndex):
            ...
            return RangeIndex.from_range(data, copy=copy, dtype=dtype, name=name)
    ...
    def map(self, mapper, na_action=None):
        ...
        new_values = super(Index, self)._map_values(mapper, na_action=na_action)
