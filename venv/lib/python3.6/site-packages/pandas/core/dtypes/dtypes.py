...
from .base import _DtypeOpsMixin
...
class PeriodDtype(ExtensionDtype, PandasExtensionDtype):
    ...
    def construct_from_string(cls, string):
        ...
        if (
            isinstance(string, compat.string_types)
            and (string.startswith("period[") or string.startswith("Period["))
            or isinstance(string, DateOffset)
        ):
...
class IntervalDtype(PandasExtensionDtype, ExtensionDtype):
    ...
    def __new__(cls, subtype=None):
        ...
        if isinstance(subtype, IntervalDtype):
            ...
            u.subtype = None
            return u
        elif isinstance(subtype, compat.string_types) and subtype.lower() == "interval":
            subtype = None
        else:
