...
from pandas.core.dtypes.missing import _infer_fill_value
...
class _IXIndexer(_NDFrameIndexer):
    ...
    def __init__(self, name, obj):
        warnings.warn(self._ix_deprecation_warning, DeprecationWarning, stacklevel=2)
    ...
    **Getting values with a MultiIndex**
    ...
    def _get_partial_string_timestamp_match_key(self, key, labels):
        ...
        if isinstance(labels, MultiIndex):
            if isinstance(key, compat.string_types) and labels.levels[0].is_all_dates:
            ...
            if isinstance(key, tuple):
                ...
                for i, component in enumerate(key):
                    if (
                        isinstance(component, compat.string_types)
