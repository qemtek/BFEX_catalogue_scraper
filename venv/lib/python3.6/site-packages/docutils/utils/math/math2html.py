...
class BibStylesConfig(object):
    ...
    defaulttags = {"YY": "??", "authors": "", "surname": ""}
...
class GeneralConfig(object):
    ...
    version = {"date": "2015-02-26", "lyxformat": "413", "number": "1.2.5"}
...
class ImageConfig(object):
    ...
    cropboxformats = {".eps": "ps", ".pdf": "pdf", ".ps": "ps"}

    formats = {"default": ".png", "vector": [".svg", ".eps"]}
...
class FilePosition(Position):
    ...
    def current(self):
        ...
        if self.pos > len(self.reader.currentline()):
            Trace.error(
                "Out of the line " + self.reader.currentline() + ": " + str(self.pos)
            )
            return "*"
